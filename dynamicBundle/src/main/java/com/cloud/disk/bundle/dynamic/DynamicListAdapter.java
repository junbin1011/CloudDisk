...
public class DynamicListAdapter extends RecyclerView.Adapter<DynamicListAdapter.ViewHolder> {
    public List<Dynamic> infoList = new ArrayList<>();
    public Context context;
    public LayoutInflater inflater;

    public DynamicListAdapter(List<Dynamic> list, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.dynamic_list_item, parent, false);
